...
-- Immutable, tenant-scoped calendar definitions referenced by published contracts. The legacy
-- table above remains the mutable source for CM_SLA_POLICY and is intentionally not migrated.
...
CREATE TABLE CM_SLA_RECORD (
    ...
    CANCELLED_AT_   TIMESTAMP WITH TIME ZONE,
    BREACHED_AT_    TIMESTAMP WITH TIME ZONE,
    CALENDAR_SHA256_ VARCHAR2(64 BYTE),
    VERSION_        NUMBER(19)     DEFAULT 0 NOT NULL,
